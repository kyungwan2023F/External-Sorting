...
/**
 * Basic handling of binary data files. Uses a single byte array as a buffer for
 * disc operations Each record is one long, and one double. Sorting key is the
 * double. A record is 16 bytes long, and there are 512 records per block. Can
 * be extended in several ways (writeSortedRecords()? readBlock(int)?)
 * 
 * @author CS Staff
 * @version Fall 2024
 */
